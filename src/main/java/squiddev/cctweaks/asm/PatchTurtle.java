		...
		for (MethodNode method : classNode.methods) {
			if (method.name.equals("execute") && method.desc.equals("(Ldan200/computercraft/api/turtle/ITurtleAccess;)Ldan200/computercraft/api/turtle/TurtleCommandResult;")) {
				...
				*/
				...
				// Get iterator
				method.visitFieldInsn(GETSTATIC, "squiddev/cctweaks/registry/TurtleTweakRegistry", "refuelList", "Ljava/util/List;");
				...
				method.visitTypeInsn(CHECKCAST, "squiddev/cctweaks/turtle/ITurtleRefuelSource");
				...
				method.visitMethodInsn(INVOKEINTERFACE, "squiddev/cctweaks/turtle/ITurtleRefuelSource", "canRefuel", "(Ldan200/computercraft/api/turtle/ITurtleAccess;Lnet/minecraft/item/ItemStack;I)Z", true);
				...
				// Refuel and add fuel
				method.visitFrame(Opcodes.F_APPEND, 1, new Object[]{"squiddev/cctweaks/turtle/ITurtleRefuelSource"}, 0, null);
				method.visitVarInsn(ALOAD, 1);
				method.visitVarInsn(ALOAD, 4);
				method.visitVarInsn(ALOAD, 1);
				method.visitVarInsn(ALOAD, 2);
				method.visitVarInsn(ALOAD, 0);
				method.visitFieldInsn(GETFIELD, "dan200/computercraft/shared/turtle/core/TurtleRefuelCommand", "m_limit", "I");
				method.visitMethodInsn(INVOKEINTERFACE, "squiddev/cctweaks/turtle/ITurtleRefuelSource", "refuel", "(Ldan200/computercraft/api/turtle/ITurtleAccess;Lnet/minecraft/item/ItemStack;I)I", true);
