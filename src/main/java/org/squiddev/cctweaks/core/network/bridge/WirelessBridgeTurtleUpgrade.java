...
/**
 * Turtle upgrade for the {@link WirelessBridgeTile} tile
 */
public class WirelessBridgeTurtleUpgrade implements ITurtleUpgrade, IModule {
	@Override
	...
	public ItemStack getCraftingItem() {
		return new ItemStack(Registry.blockNetworkedBlock, 0);
	}
	...
	public IIcon getIcon(ITurtleAccess turtle, TurtleSide side) {
		return NetworkedBlock.bridgeSmallIcon;
	}
