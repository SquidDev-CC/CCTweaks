...
public final class CommandCCTweaks {
	...
	public static ICommand create(MinecraftServer server) {
...

		{
			...
			profile.register(new SubCommandBase(
				...
				public void execute(@Nonnull CommandContext context, @Nonnull List<String> arguments) throws CommandException {
					...
					context.getSender().addChatMessage(list(
						text("Run "),
		...
		root.register(new SubCommandBase(
			...
			public void execute(@Nonnull CommandContext context, @Nonnull List<String> arguments) throws CommandException {
				...
				context.getSender().addChatMessage(text("Shutdown " + shutdown + " / " + computers.size()));
			}
			...
			public void execute(@Nonnull CommandContext context, @Nonnull List<String> arguments) throws CommandException {
				...
				if (sender instanceof EntityPlayerMP) {
					...
					if (entity.getEntityWorld() != world) {
						context.getServer().getConfigurationManager().transferPlayerToDimension(entity, world.provider.getDimensionId());
					}
					...
					if (entity.getEntityWorld() != world) {
						entity.travelToDimension(world.provider.getDimensionId());
					}
	...
	private static IChatComponent linkPosition(CommandContext context, ServerComputer computer) {
